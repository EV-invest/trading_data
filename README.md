...
![spl replayed — chart panes left, the graph right](./docs/.readme_assets/assets/overview.jpeg)
...
![one element sequence, four groupings of it into ticks](./docs/.readme_assets/assets/fuzz.svg)
