//! The five acquisition lanes' progress bars, in scam_pump_liqs' `fetch::ui` style: one steady-tick
//! lane bar each, finished green so the completed bars are the run's summary.
