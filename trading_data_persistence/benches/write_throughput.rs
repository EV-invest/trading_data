...
use trading_data_persistence::{BatchWindow, BookShape, BookUpdate, Catalog, Feather, Feed, Live, LiveClock, RotationPolicy, Trade, TradeBuf};
...
fn push_200_snapshots() {
	...
	let mut live = Live::new(cat, ExchangeName::Binance, symbol, prec(), true, Arc::new(LiveClock), BatchWindow::ZERO);
	let sink = live.sink();
